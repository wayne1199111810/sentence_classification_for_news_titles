...
python cnn_main.py uci w2v ../data/sentence_classification_for_news_titles/trainCorpora.csv ../data/sentence_classification_for_news_titles/validCorpora.csv config/config_w2v_uci.json LOG/cnn_w2v_uci model/w2v_uci
...
python cnn_main.py uci bow ../data/sentence_classification_for_news_titles/newsCorpora.shuffled.csv ../data/sentence_classification_for_news_titles/newsCorpora.shuffled.csv config/config_bow_uci.json LOG/cnn_bow_uci model/bow_uci
